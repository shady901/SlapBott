...
namespace SlapBott.Data.Migrations
{
    ...
    [Migration("20240611224821_loottable 2")]
    partial class loottable2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SlapBott.Data.Models.Item", b =>
                {
                    ...
                    b.Property<int?>("AcuiredThroughType")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("SlapBott.Data.Models.Material", b =>
                {
                    ...
                    b.Property<string>("CanBeUsedInProffesions")
                        .IsRequired()
                        .HasColumnType("TEXT");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            AcuiredThroughType = 1,
                            AreaType = 1,
                            Description = "An Ore Found in Caves that can be used to Craft Iron Gear at a BlackSmith",
                            EnemyType = 0,
                            FoundLevel = 2,
                            Name = "Iron Ore",
                            Regions = 4,
                            CanBeUsedInProffesions = "[1]"
                        });
                });
            ...
            modelBuilder.Entity("SlapBott.Data.Models.Equipment", b =>
                {
                    b.HasOne("SlapBott.Data.Models.Consumable", "Consumable")
                        .WithMany()
                        .HasForeignKey("ConsumableId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("SlapBott.Data.Models.Material", "Material")
                        .WithMany()
            ...
            modelBuilder.Entity("SlapBott.Data.Models.LootTable", b =>
                {
                    b.HasOne("SlapBott.Data.Models.Character", null)
                        .WithMany("LootTable")
                        .HasForeignKey("CharacterId")
                        .OnDelete(DeleteBehavior.NoAction);
